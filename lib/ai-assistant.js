...
const APP_KNOWLEDGE_COMPACT = [
    ...
    'Company Profile controls company branding, app name, login background, menu labels, order form options, and sales report filter visibility. Invoice Template controls receipt title, subtitle, business info, logo, signature, layout, footer notes, and terms. Settings controls profile, password, login email connection, Google connection, and profile photo.',
