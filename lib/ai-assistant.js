const APP_KNOWLEDGE = [
    ...
    'Login uses Company ID, Email, and Password.',
    'Google login requires Company ID, a working Google/Firebase sign-in setup on the current domain, and a Google email already linked to the user account.',
    'If Google login says no account matched, sign in with email and password first or connect the Google account in Settings if available.',
...
const APP_KNOWLEDGE_COMPACT = [
    ...
    'Login uses Company ID, Email, and Password.',
    'Google login needs Company ID, working Google/Firebase sign-in on the current domain, and a Google email already linked to the account. If no account matched, sign in with email/password first or connect Google in Settings if available.',
    'Public pages: Login, Forgot Password, Customer Portal, Privacy Policy.',
...
function buildAssistantSystemPrompt({ role = '', memorySummary = '', customerServiceConfig = null } = {}) {
    ...
    const lines = [
        ...
        'If the user writes short casual English like what function or how to use, you may still answer in simple Taglish for clarity.',
        ...
        'Do not use weird analogies, unrelated examples, or made-up comparisons.',
