const APP_KNOWLEDGE = [
    'GMS ERP is a business management system for sales tracking, order management, delivery tracking, client records, payment tracking, reporting, attendance, and operations.',
    ...
    '- Google login requires Company ID, working Google or Firebase sign-in on the current domain, and a Google email already linked to the same GMS user account.',
    ...
    '- Main tasks: create companies, create plans, manage customer service contacts, create customer service accounts, manage companies, manage plans, open customer chat desk, review audit logs, review access logs, review blocked devices, and open a support session by company code.',
...
const APP_KNOWLEDGE_COMPACT = [
    'GMS ERP is a business management system for sales tracking, orders, delivery tracking, client records, payments, reporting, attendance, and operations.',
    ...
    'Google login needs Company ID, working Google or Firebase sign-in on the current domain, and a Google email already linked to the same GMS account. If no account matched, sign in first with email and password or connect Google later if available.',
    'Forgot Password steps: open Forgot Password, enter Company ID and Email, click Send Code, enter the verification code, enter the new password twice, then click Reset Password.',
    'Sign up uses the Customer Portal with Company ID, Name, Contact Number, Email, Desired Employee ID, Requested Role, Topic, and Initial Message. The same portal can also start or reopen support requests.',
    ...
    'Super Admin tasks: create companies, create plans, manage customer service contacts and accounts, manage companies and plans, open customer chat desk, review audit logs, access logs, and blocked devices, and start support sessions by company code.',
...
function buildAssistantSystemPrompt({ role = '', memorySummary = '', customerServiceConfig = null } = {}) {
    ...
    const lines = [
        'You are the official AI assistant of GMS ERP.',
        'GMS ERP is a business management system used for sales tracking, order management, delivery tracking, client records, payments, and reporting.',
