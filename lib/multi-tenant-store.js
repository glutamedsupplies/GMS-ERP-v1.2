...
const UNPAID_LUNCH_BREAK_MINUTES = 60;
const LUNCH_BREAK_TRIGGER_MINUTES = 6 * 60;

function calculateWorkedHours(timeIn, timeOut, scheduledTimeIn = '', scheduledTimeOut = '') {
    ...
    const effectiveStartMinutes = scheduledMinutes === null
        ? timeInMinutes
    ...
    if (workedMinutes >= LUNCH_BREAK_TRIGGER_MINUTES) {
        workedMinutes = Math.max(0, workedMinutes - UNPAID_LUNCH_BREAK_MINUTES);
    }
