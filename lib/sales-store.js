...
function normalizeLbcTrackingEntry(entry = {}, { fallbackAmount = 0, generateId = true } = {}) {
    ...
    return {
        ...
        deliveryStatus: normalizeLbcTrackingStatus(
...
function updateLbcTracking(orderLookup, payload = {}) {
    ...
    if (requestedCollectionStatus === 'Confirmed' && summaryDeliveryStatus !== 'Delivered') {
    ...
    if (summaryDeliveryStatus !== 'Delivered') {
